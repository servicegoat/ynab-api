...
class Category(object):
    ...
    def __init__(self, id=None, category_group_id=None, category_group_name=None, name=None, hidden=None, original_category_group_id=None, note=None, budgeted=None, activity=None, balance=None, goal_type=None, goal_day=None, goal_cadence=None, goal_cadence_frequency=None, goal_creation_month=None, goal_target=None, goal_target_month=None, goal_percentage_complete=None, goal_months_to_budget=None, goal_under_funded=None, goal_overall_funded=None, goal_overall_left=None, deleted=None):  # noqa: E501
        ...
        self._goal_day = None
        self._goal_cadence = None
        self._goal_cadence_frequency = None
        ...
        if goal_cadence is not None:
            self.goal_cadence = goal_cadence
        if goal_cadence_frequency is not None:
            self.goal_cadence_frequency = goal_cadence_frequency
    ...
    @property
    def category_group_name(self):
        """Gets the category_group_name of this Category.  # noqa: E501


        :return: The category_group_name of this Category.  # noqa: E501
        :rtype: str
        """
        return self._category_group_name

    @category_group_name.setter
    def category_group_name(self, category_group_name):
        """Sets the category_group_name of this Category.


        :param category_group_name: The category_group_name of this Category.  # noqa: E501
        :type: str
        """

        self._category_group_name = category_group_name
    ...
    def original_category_group_id(self):
        ...
        DEPRECATED: No longer used.  Value will always be null.  # noqa: E501
    ...
    def goal_type(self, goal_type):
        ...
        :type: str
        """
        allowed_values = ["TB", "TBD", "MF", "NEED", "DEBT"]  # noqa: E501
    ...
    @property
    def goal_day(self):
        """Gets the goal_day of this Category.  # noqa: E501

        A day offset modifier for the goal's due date. When goal_cadence is 2 (Weekly), this value specifies which day of the week the goal is due (0 = Sunday, 6 = Saturday). Otherwise, this value specifies which day of the month the goal is due (1 = 1st, 31 = 31st, null = Last day of Month).  # noqa: E501

        :return: The goal_day of this Category.  # noqa: E501
        :rtype: int
        """
        return self._goal_day

    @goal_day.setter
    def goal_day(self, goal_day):
        """Sets the goal_day of this Category.

        A day offset modifier for the goal's due date. When goal_cadence is 2 (Weekly), this value specifies which day of the week the goal is due (0 = Sunday, 6 = Saturday). Otherwise, this value specifies which day of the month the goal is due (1 = 1st, 31 = 31st, null = Last day of Month).  # noqa: E501

        :param goal_day: The goal_day of this Category.  # noqa: E501
        :type: int
        """

        self._goal_day = goal_day

    @property
    def goal_cadence(self):
        """Gets the goal_cadence of this Category.  # noqa: E501

        The goal cadence. Value in range 0-14. There are two subsets of these values which behave differently. For values 0, 1, 2, and 13, the goal's due date repeats every goal_cadence * goal_cadence_frequency, where 0 = None, 1 = Monthly, 2 = Weekly, and 13 = Yearly. For example, goal_cadence 1 with goal_cadence_frequency 2 means the goal is due every other month. For values 3-12 and 14, goal_cadence_frequency is ignored and the goal's due date repeats every goal_cadence, where 3 = Every 2 Months, 4 = Every 3 Months, ..., 12 = Every 11 Months, and 14 = Every 2 Years.  # noqa: E501

        :return: The goal_cadence of this Category.  # noqa: E501
        :rtype: int
        """
        return self._goal_cadence

    @goal_cadence.setter
    def goal_cadence(self, goal_cadence):
        """Sets the goal_cadence of this Category.

        The goal cadence. Value in range 0-14. There are two subsets of these values which behave differently. For values 0, 1, 2, and 13, the goal's due date repeats every goal_cadence * goal_cadence_frequency, where 0 = None, 1 = Monthly, 2 = Weekly, and 13 = Yearly. For example, goal_cadence 1 with goal_cadence_frequency 2 means the goal is due every other month. For values 3-12 and 14, goal_cadence_frequency is ignored and the goal's due date repeats every goal_cadence, where 3 = Every 2 Months, 4 = Every 3 Months, ..., 12 = Every 11 Months, and 14 = Every 2 Years.  # noqa: E501

        :param goal_cadence: The goal_cadence of this Category.  # noqa: E501
        :type: int
        """

        self._goal_cadence = goal_cadence

    @property
    def goal_cadence_frequency(self):
        """Gets the goal_cadence_frequency of this Category.  # noqa: E501

        The goal cadence frequency. When goal_cadence is 0, 1, 2, or 13, a goal's due date repeats every goal_cadence * goal_cadence_frequency. For example, goal_cadence 1 with goal_cadence_frequency 2 means the goal is due every other month.  When goal_cadence is 3-12 or 14, goal_cadence_frequency is ignored.  # noqa: E501

        :return: The goal_cadence_frequency of this Category.  # noqa: E501
        :rtype: int
        """
        return self._goal_cadence_frequency

    @goal_cadence_frequency.setter
    def goal_cadence_frequency(self, goal_cadence_frequency):
        """Sets the goal_cadence_frequency of this Category.

        The goal cadence frequency. When goal_cadence is 0, 1, 2, or 13, a goal's due date repeats every goal_cadence * goal_cadence_frequency. For example, goal_cadence 1 with goal_cadence_frequency 2 means the goal is due every other month.  When goal_cadence is 3-12 or 14, goal_cadence_frequency is ignored.  # noqa: E501

        :param goal_cadence_frequency: The goal_cadence_frequency of this Category.  # noqa: E501
        :type: int
        """

        self._goal_cadence_frequency = goal_cadence_frequency
