...
class TransactionSummary(object):
    ...
    def __init__(self, id=None, _date=None, amount=None, memo=None, cleared=None, approved=None, flag_color=None, account_id=None, payee_id=None, category_id=None, transfer_account_id=None, transfer_transaction_id=None, matched_transaction_id=None, import_id=None, import_payee_name=None, import_payee_name_original=None, debt_transaction_type=None, deleted=None):  # noqa: E501
        ...
        self._import_payee_name = None
        self._import_payee_name_original = None
        self._debt_transaction_type = None
        self._deleted = None
        ...
        if import_payee_name is not None:
            self.import_payee_name = import_payee_name
        if import_payee_name_original is not None:
            self.import_payee_name_original = import_payee_name_original
        if debt_transaction_type is not None:
    ...
    @property
    def import_payee_name(self):
        """Gets the import_payee_name of this TransactionSummary.  # noqa: E501

        If the transaction was imported, the payee name that was used when importing and before applying any payee rename rules  # noqa: E501

        :return: The import_payee_name of this TransactionSummary.  # noqa: E501
        :rtype: str
        """
        return self._import_payee_name

    @import_payee_name.setter
    def import_payee_name(self, import_payee_name):
        """Sets the import_payee_name of this TransactionSummary.

        If the transaction was imported, the payee name that was used when importing and before applying any payee rename rules  # noqa: E501

        :param import_payee_name: The import_payee_name of this TransactionSummary.  # noqa: E501
        :type: str
        """

        self._import_payee_name = import_payee_name

    @property
    def import_payee_name_original(self):
        """Gets the import_payee_name_original of this TransactionSummary.  # noqa: E501

        If the transaction was imported, the original payee name as it appeared on the statement  # noqa: E501

        :return: The import_payee_name_original of this TransactionSummary.  # noqa: E501
        :rtype: str
        """
        return self._import_payee_name_original

    @import_payee_name_original.setter
    def import_payee_name_original(self, import_payee_name_original):
        """Sets the import_payee_name_original of this TransactionSummary.

        If the transaction was imported, the original payee name as it appeared on the statement  # noqa: E501

        :param import_payee_name_original: The import_payee_name_original of this TransactionSummary.  # noqa: E501
        :type: str
        """

        self._import_payee_name_original = import_payee_name_original

    @property
    def debt_transaction_type(self):
        """Gets the debt_transaction_type of this TransactionSummary.  # noqa: E501

        If the transaction is a debt/loan account transaction, the type of transaction  # noqa: E501

        :return: The debt_transaction_type of this TransactionSummary.  # noqa: E501
        :rtype: str
        """
        return self._debt_transaction_type

    @debt_transaction_type.setter
    def debt_transaction_type(self, debt_transaction_type):
        """Sets the debt_transaction_type of this TransactionSummary.

        If the transaction is a debt/loan account transaction, the type of transaction  # noqa: E501

        :param debt_transaction_type: The debt_transaction_type of this TransactionSummary.  # noqa: E501
        :type: str
        """
        allowed_values = ["payment", "refund", "fee", "interest", "escrow", "balancedAdjustment", "credit", "charge"]  # noqa: E501
        if debt_transaction_type not in allowed_values:
            raise ValueError(
                "Invalid value for `debt_transaction_type` ({0}), must be one of {1}"  # noqa: E501
                .format(debt_transaction_type, allowed_values)
            )

        self._debt_transaction_type = debt_transaction_type
