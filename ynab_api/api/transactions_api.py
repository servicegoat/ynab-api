...
class TransactionsApi(object):
    ...
    def create_transaction(self, body, budget_id, **kwargs):  # noqa: E501
        ...
        :param PostTransactionsWrapper body: The transaction or transactions to create.  To create a single transaction you can specify a value for the `transaction` object and to create multiple transactions you can specify an array of `transactions`.  It is expected that you will only provide a value for one of these objects. (required)
        :param str budget_id: The id of the budget. \"last-used\" can be used to specify the last used budget and \"default\" can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget). (required)
    ...
    def delete_transaction(self, budget_id, transaction_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_transaction_with_http_info(budget_id, transaction_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_transaction_with_http_info(budget_id, transaction_id, **kwargs)  # noqa: E501
            return data

    def delete_transaction_with_http_info(self, budget_id, transaction_id, **kwargs):  # noqa: E501
        """Deletes an existing transaction  # noqa: E501

        Deletes a transaction  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_transaction_with_http_info(budget_id, transaction_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('budget_id' not in params or
                params['budget_id'] is None):
            raise ValueError("Missing the required parameter `budget_id` when calling `delete_transaction`")  # noqa: E501
    ...
    def update_transaction(self, body, budget_id, transaction_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param PutTransactionWrapper body: The transaction to update (required)
        :param str budget_id: The id of the budget. \"last-used\" can be used to specify the last used budget and \"default\" can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget). (required)
        :param str transaction_id: The id of the transaction (required)
        :return: TransactionResponse
                 If the method is called asynchronously,
